...
/**
 * @author DateTime:2018年11月22日 下午9:25:20
...
public class WsTest {
    ...
    public static void main(String[] args) {
        try {
//wsurl
            String url = "wss://wspool.hiotc.pro/kline-api/ws";
//历史数据请求参数
            String reqParam = "{\"event\":\"req\",\"params\":{\"channel\":\"market_btcusdt_depth_step0\",\"cb_id\":\"1\"}}";
//订阅参数
            String subParam = "{\"event\":\"sub\",\"params\":{\"channel\":\"market_btcusdt_depth_step0\",\"cb_id\":\"1\"}}";
