...
public class CurrentOpenOrders {
    /**
     * GET请求方式/当前订单
     * GET Request method/Current Open Orders
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sign  = Signature.toSign(timestemp, "GET", "/sapi/v1/margin/openOrders", "", "", secret);
        String url = "https://openapi.xxx.com/sapi/v1/margin/openOrders?symbol=btcusdt";
