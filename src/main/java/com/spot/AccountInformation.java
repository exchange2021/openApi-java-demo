...
public class AccountInformation {
    /**
     * GET请求方式/账户信息
     * GET Request method/Account Information
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sign  = Signature.toSign(timestemp, "GET", "/sapi/v1/account", "", "", secret);
        String url = "https://openapi.xxx.com/sapi/v1/account";
